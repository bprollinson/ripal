...
public class RegularExpressionSyntaxCompilerTest
{
    ...
    public void testCompileReturnsEpsilonNFAForCharacterNode()
    {
        ...
        state.addTransition(new StateTransition<Character>('a', new EpsilonNFAState("S1", true)));
    ...
    public void testCompilerReturnsEpsilonNFAForKleeneClosureNode()
    {
        ...
        state2.addTransition(new StateTransition<Character>(null, state1));
    ...
    public void testCompilerReturnsEpsilonNFAForConcatenationNodeWithMultipleChildren()
    {
        ...
        state3.addTransition(new StateTransition<Character>('b', state4));
        state4.addTransition(new StateTransition<Character>(null, state5));
        state5.addTransition(new StateTransition<Character>('c', state6));
        EpsilonNFA expectedEpsilonNFA = new EpsilonNFA(state1);
    ...
    public void testCompilerReturnsEpsilonNFAForOrNode()
    {
        ...
        startState.addTransition(new StateTransition<Character>(null, upperState1));
        startState.addTransition(new StateTransition<Character>(null, middleState1));
        startState.addTransition(new StateTransition<Character>(null, lowerState1));
        upperState1.addTransition(new StateTransition<Character>('a', upperState2));
        middleState1.addTransition(new StateTransition<Character>('b', middleState2));
        lowerState1.addTransition(new StateTransition<Character>('c', lowerState2));
        upperState2.addTransition(new StateTransition<Character>(null, endState));
        middleState2.addTransition(new StateTransition<Character>(null, endState));
        lowerState2.addTransition(new StateTransition<Character>(null, endState));
