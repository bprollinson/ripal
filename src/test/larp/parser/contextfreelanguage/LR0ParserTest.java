...
public class LR0ParserTest
{
    ...
    public void testGetAppliedRulesReturnsRuleIndexesUntilTableLookupFailure() throws AmbiguousLR0ParseTableException
    {
        ...
        LR0ProductionSetDFAState state6 = new LR0ProductionSetDFAState("", false, new HashSet<Node>());
    ...
    public void testStructureEqualsReturnsTrueWhenParseTablesHaveSameStructure() throws AmbiguousLR0ParseTableException
    {
        ...
        LR0ProductionSetDFAState startState = new LR0ProductionSetDFAState("", false, new HashSet<Node>());
        ...
        LR0ProductionSetDFAState otherStartState = new LR0ProductionSetDFAState("", false, new HashSet<Node>());
